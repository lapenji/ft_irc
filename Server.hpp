...
private:
    ...
    void    ft_manage_mode(const std::string& tmp, int client_fd, const std::string& nick, const std::string& user);
    //void    ft_manage_join(const std::string& tmp, int client_fd);
    void    ft_manage_join(const std::string& tmp, int client_fd, Client* client, const std::string& nick, const std::string& user);
    ...
    void    ft_manage_invite(const std::string& tmp, int client_fd, const std::string& nick, const std::string& user);
    ...
    void    ft_manage_kick(const std::string& tmp, int client_fd, const std::string& nick, const std::string& user);
