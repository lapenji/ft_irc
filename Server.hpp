...
private:
    ...
    // void    ft_manage_nick(const std::string& tmp, int client_fd);
    ...
    void ft_manage_mode(const std::string &tmp, int client_fd, const std::string &nick, const std::string &user, const std::string &ip);
    ...
    void ft_manage_privmsg(const std::string &tmp, int client_fd, const std::string &nick, const std::string &ip);
    // void    ft_manage_invite(const std::string& tmp, int client_fd);
    void ft_manage_invite(const std::string &tmp, int client_fd, const std::string &nick, const std::string &user, const std::string &ip);
    ...
    void ft_manage_kick(const std::string &tmp, int client_fd, const std::string &nick, const std::string &user, const std::string &ip);
