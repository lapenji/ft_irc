...
std::string Channel::getUsersAsEq()
{
    std::string res = "";
    std::map<int, Client *>::const_iterator it = this->clients.begin();
    while (it != this->clients.end())
...
bool Channel::getIsBotInside()
{
    return this->isBotInside;
}
void Channel::setIsBotInside(bool arg)
{
